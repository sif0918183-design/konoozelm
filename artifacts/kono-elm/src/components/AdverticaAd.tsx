 ...
 *
 * Renders HilltopAds MultiTag script inside an isolated iframe container slot across page ad positions.
 */
  ...
  return (
    <div className={`my-2 mx-auto flex justify-center items-center overflow-hidden w-full max-w-full text-center ${className}`}>
      <iframe
        ...
        width="300"
        height="250"
        className="border-0 overflow-hidden bg-transparent rounded-2xl shadow-sm"
        style={{
          border: 0,
          width: '100%',
          maxWidth: '300px',
