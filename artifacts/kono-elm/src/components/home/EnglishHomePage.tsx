    ...
    <div className="min-h-screen bg-[#fcfcf8]">
      ...
      <header className="bg-primary-900 text-white pt-12 md:pt-20 pb-20 md:pb-24 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 mt-12 md:mt-0 flex flex-col items-center">
          <Logo lang="en" className="mb-4" />
          <h1 className="text-3xl md:text-5xl font-bold mb-4 text-gold-200 drop-shadow-sm font-playfair">
            {t.title}
          </h1>
      ...
      <main className="max-w-7xl mx-auto px-4 -mt-10 relative z-20 pb-20">
        ...
        {!hasSearched && !isLoading && featuredCategories.length > 0 && (
          <div className="mb-12">
            <h2 className="text-xl font-bold text-primary-900 mb-6 border-l-4 border-gold-500 pl-4">{t.featured_categories}</h2>
