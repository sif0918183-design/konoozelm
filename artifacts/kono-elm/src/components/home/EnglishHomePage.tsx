...
export default function EnglishHomePage({ initialCategories = [], initialFeaturedBooks = [] }: Props) {
  ...
  return (
    <div className="min-h-screen bg-transparent font-tajawal" dir="ltr">
      ...
      {/* Results Section */}
      <main className="max-w-7xl mx-auto px-4 mt-8 relative z-20 pb-20">
        ...
        {!hasSearched && !isLoading && (
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-primary-900 mb-8 border-l-4 border-gold-500 pl-4">{t.general_library_categories}</h2>
