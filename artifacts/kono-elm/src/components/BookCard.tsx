  ...
  const handleRead = () => {
    if (files.length > 1) {
      ...
      if (typeof window !== 'undefined' && !navigator.onLine) {
        ...
        alert(lang === 'ar' ? 'لايمكن فتح الكتاب بسبب ضعف الإنترنت، يرجى تحديث الصفحة والمحاولة مرة أخرى' : 'The book cannot be opened due to weak internet, please refresh the page and try again');
      }
    }
  };
