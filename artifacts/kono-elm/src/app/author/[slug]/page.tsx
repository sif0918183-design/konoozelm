  ...
  return (
    <div className="min-h-screen bg-[#fcfcf8] font-tajawal" dir="rtl">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12 -mt-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-8 border-r-4 border-gold-500 pr-4">مؤلفات {author.name}</h2>
        ...
        {books.length === 0 && (
          <div className="text-center py-20 bg-white rounded-3xl border border-gray-100">
            ...
            <p className="text-gray-500">لا توجد كتب مضافة لهذا المؤلف حالياً</p>
          </div>
        )}
      </main>
    </div>
