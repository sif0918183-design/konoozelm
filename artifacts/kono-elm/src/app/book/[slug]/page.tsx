...
import { BookOpen, Download, User, Tag, ChevronRight, Book as BookIcon, Sparkles } from 'lucide-react';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const seoBook = await getBookByArchiveId(archiveId);
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-8">
            ...
            <div className="md:col-span-1 space-y-6">
              ...
              <div className="space-y-4">
                <Link href={`/author/${authorSlug}`} className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl hover:bg-gold-50 transition-colors">
                  ...
                  <div>
                    <p className="text-xs text-gray-400">المؤلف</p>
                ...
                {seoBook?.parts_count && seoBook.parts_count > 1 && (
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      <p className="text-xs text-gray-400">عدد الأجزاء</p>
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <div className="prose prose-lg max-w-none">
                <h2 className="text-2xl font-bold text-gray-900 mb-4 border-r-4 border-gold-500 pr-4">نبذة عن الكتاب</h2>
